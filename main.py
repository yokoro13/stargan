...
if __name__ == '__main__':
    ...
    parser.add_argument('--selected_attrs', '--list', nargs='+', help='selected attributes for the CelebA dataset',
                        default=["black_floor", "red_brick_wall", "white_floor", "white_wall", "wood_floor",
                                 "wood_wall", "ocean", "sky"])
    ...
    # Directories.
    parser.add_argument('--celeba_image_dir', type=str, default='data/interior/images')
    parser.add_argument('--attr_path', type=str, default='data/interior/attr_interior.txt')
